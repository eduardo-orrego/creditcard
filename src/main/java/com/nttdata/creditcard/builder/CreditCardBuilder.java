    ...
    public static CreditCard toCreditCardEntity(CreditCardRequest creditCardRequest) {
        return CreditCard.builder()
            ...
            .expirationDate(Objects.nonNull(creditCardRequest.getExpirationDate())
                ? creditCardRequest.getExpirationDate() : LocalDate.now().plusYears(1))
            .activateDate(Objects.nonNull(creditCardRequest.getActivateDate())
                ? creditCardRequest.getActivateDate() : LocalDate.now())
            .cvv(Objects.nonNull(creditCardRequest.getCvv())
                ? creditCardRequest.getCvv() : generateCvv())
            .cardNumber(Objects.nonNull(creditCardRequest.getCardNumber())
                ? creditCardRequest.getCardNumber() : generateCardNumber())
            .dateCreated(LocalDateTime.now())
            .lastUpdated(LocalDateTime.now())
            .build();
    }

    public static CreditCard toCreditCardEntity(CreditCardRequest creditCardRequest, CreditCard creditCard) {
        return CreditCard.builder()
            .id(creditCard.getId())
            .status(creditCardRequest.getStatus().name())
            .customerDocument(creditCardRequest.getCustomerDocument())
            .creditNumber(creditCardRequest.getCreditNumber())
            .expirationDate(Objects.nonNull(creditCardRequest.getExpirationDate())
                ? creditCardRequest.getExpirationDate() : creditCard.getExpirationDate())
            .activateDate(Objects.nonNull(creditCardRequest.getActivateDate())
                ? creditCardRequest.getActivateDate() : creditCard.getActivateDate())
            .cvv(Objects.nonNull(creditCardRequest.getCvv())
                ? creditCardRequest.getCvv() : creditCard.getCvv())
            .cardNumber(Objects.nonNull(creditCardRequest.getCreditNumber())
                ? creditCardRequest.getCreditNumber() : creditCard.getCardNumber())
